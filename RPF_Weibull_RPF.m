...
if filter_P1
    ...
    if any(P1 < R.info.P1_LB_min) || any(P1 > R.info.P1_UB_max)
        warnText = ['In the input R struct, \n' ...
                    ...
                    'numerical issues such as imaginary solutions for P2. Consider setting the filter_P1' ...
                    'input to RPF_Weibull_RPF to 1 to filter out potentially problematic values in the P1 input.'];
        warning('RPF:invalidInput', warnText);
    end
